...
class StorePageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                Rule::unique('pages')->where(function ($query) {
                    return $query->where('organization_id', $this->organization_id)
                                 ->where('language', $this->language ?? 'es');
                }),
            ],
            ...
            'reading_level' => 'nullable|string|in:beginner,intermediate,advanced',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'template.required' => 'La plantilla es obligatoria.',
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'requires_auth' => $this->requires_auth ?? false,
            'sort_order' => $this->sort_order ?? 0,
            'cache_duration' => $this->cache_duration ?? 60,
        ]);
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($this->route) {
                $this->validateRouteUniqueness($validator);
            }
    ...
    private function validateParentRelationship($validator): void
    {
        ...
        if ($parent) {
            ...
            if ($parent->parent_id && $parent->parent_id === $this->id) {
                $validator->errors()->add('parent_id', 'No se puede crear una referencia circular.');
            }
        }
    }
     ...
     * Validate route uniqueness.
     */
    private function validateRouteUniqueness($validator): void
    {
