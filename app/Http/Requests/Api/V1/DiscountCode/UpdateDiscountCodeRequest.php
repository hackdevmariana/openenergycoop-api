    ...
    public function rules(): array
    {
        return [
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('discount_codes', 'code')->ignore($this->discountCode)
            ],
            ...
            'is_first_time_only' => 'sometimes|boolean',
            'is_new_customer_only' => 'sometimes|boolean',
            'is_returning_customer_only' => 'sometimes|boolean',
            ...
            'max_stack_count' => 'sometimes|nullable|integer|min:1',
