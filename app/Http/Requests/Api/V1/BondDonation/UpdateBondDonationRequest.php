...
class UpdateBondDonationRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'donor_id' => ['sometimes', 'nullable', 'exists:users,id'],
            'donor_name' => ['sometimes', 'string', 'max:255'],
            'donor_email' => ['sometimes', 'email', 'max:255'],
            'donor_phone' => ['sometimes', 'nullable', 'string', 'max:20'],
            'donor_address' => ['sometimes', 'nullable', 'string', 'max:500'],
            'donor_city' => ['sometimes', 'nullable', 'string', 'max:100'],
            'donor_state' => ['sometimes', 'nullable', 'string', 'max:100'],
            'donor_country' => ['sometimes', 'nullable', 'string', 'max:100'],
            'donor_postal_code' => ['sometimes', 'nullable', 'string', 'max:20'],
            'energy_bond_id' => ['sometimes', 'exists:energy_bonds,id'],
            'organization_id' => ['sometimes', 'nullable', 'exists:organizations,id'],
            'campaign_id' => ['sometimes', 'nullable', 'exists:campaigns,id'],
            'donation_type' => ['sometimes', 'string', Rule::in([
            ...
            'dedication_name' => ['sometimes', 'nullable', 'string', 'max:255'],
            'dedication_message' => ['sometimes', 'nullable', 'string', 'max:500'],
            'recurring_frequency' => ['sometimes', 'nullable', 'string', Rule::in([
                'weekly', 'monthly', 'quarterly', 'annually'
            ])],
            'recurring_start_date' => ['sometimes', 'nullable', 'date', 'after_or_equal:today'],
            'recurring_end_date' => ['sometimes', 'nullable', 'date', 'after:recurring_start_date'],
            'tax_receipt_required' => ['sometimes', 'boolean'],
            'tax_receipt_sent' => ['sometimes', 'boolean'],
            'tax_receipt_number' => ['sometimes', 'nullable', 'string', 'max:100'],
            'tax_receipt_date' => ['sometimes', 'nullable', 'date'],
    ...
    {
        return [
            'donor_name.string' => 'El nombre del donante debe ser una cadena de texto.',
            ...
            'donation_type.string' => 'El tipo de donación debe ser una cadena de texto.',
            ...
            'recurring_frequency.string' => 'La frecuencia recurrente debe ser una cadena de texto.',
