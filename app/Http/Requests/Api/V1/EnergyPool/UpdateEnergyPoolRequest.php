...
class UpdateEnergyPoolRequest extends FormRequest
{
    /**
    ...
    {
        $energyPoolId = $this->route('energyPool')->id ?? $this->route('id');
        ...
        return [
            'pool_number' => [
                ...
                'string',
                'max:255',
                Rule::unique('energy_pools', 'pool_number')->ignore($energyPoolId)
            ],
            'name' => 'sometimes|string|max:255',
            'description' => 'sometimes|nullable|string|max:65535',
            'pool_type' => ['sometimes', 'string', Rule::in(array_keys(EnergyPool::getPoolTypes()))],
            'status' => ['sometimes', 'string', Rule::in(array_keys(EnergyPool::getStatuses()))],
            'energy_category' => ['sometimes', 'string', Rule::in(array_keys(EnergyPool::getEnergyCategories()))],
            'total_capacity_mw' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'available_capacity_mw' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'reserved_capacity_mw' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'utilized_capacity_mw' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'efficiency_rating' => 'sometimes|nullable|numeric|min:0|max:100',
            'availability_factor' => 'sometimes|nullable|numeric|min:0|max:100',
            'capacity_factor' => 'sometimes|nullable|numeric|min:0|max:100',
            'annual_production_mwh' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'monthly_production_mwh' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'daily_production_mwh' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'hourly_production_mwh' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            ...
            'commissioning_date' => 'sometimes|nullable|date|before_or_equal:today',
            'decommissioning_date' => 'sometimes|nullable|date|after:commissioning_date',
            'expected_lifespan_years' => 'sometimes|nullable|integer|min:1|max:100',
            'construction_cost' => 'sometimes|nullable|numeric|min:0|max:999999999.99',
            'operational_cost_per_mwh' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'maintenance_cost_per_mwh' => 'sometimes|nullable|numeric|min:0|max:999999.99',
            'technical_specifications' => 'sometimes|nullable|array',
            'environmental_impact' => 'sometimes|nullable|array',
            'regulatory_compliance' => 'sometimes|nullable|array',
            'safety_features' => 'sometimes|nullable|array',
            'pool_members' => 'sometimes|nullable|array',
            'pool_operators' => 'sometimes|nullable|array',
            'pool_governance' => 'sometimes|nullable|array',
            'trading_rules' => 'sometimes|nullable|array',
            'settlement_procedures' => 'sometimes|nullable|array',
            'risk_management' => 'sometimes|nullable|array',
            'performance_metrics' => 'sometimes|nullable|array',
            'environmental_data' => 'sometimes|nullable|array',
            'regulatory_documents' => 'sometimes|nullable|array',
