    ...
    public function rules(): array
    {
        return [
            ...
            'email' => [
                ...
                'email',
                'max:255',
                Rule::unique('affiliates', 'email')->ignore($this->affiliate)
            ],
            ...
            'banking_info' => 'sometimes|nullable|array',
            ...
            'tax_info' => 'sometimes|nullable|array',
            'tax_info.tax_id' => 'nullable|string|max:100',
            'tax_info.tax_exempt' => 'boolean',
            'tax_info.tax_exemption_number' => 'nullable|string|max:100',
            'performance_rating' => 'sometimes|nullable|integer|between:1,5',
            'rating_notes' => 'sometimes|nullable|string|max:1000',
            'rate_change_reason' => 'sometimes|nullable|string|max:1000',
