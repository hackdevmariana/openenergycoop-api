...
class StoreMaintenanceTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'task_type' => ['required', 'string', Rule::in([
            ...
            'estimated_hours' => ['required', 'numeric', 'min:0.1', 'max:1000'],
            'estimated_cost' => ['nullable', 'numeric', 'min:0', 'max:999999.99'],
            'actual_start_time' => ['nullable', 'date', 'before_or_equal:due_date'],
            ...
            'tools_required' => ['nullable', 'string', 'max:500'],
            'safety_requirements' => ['nullable', 'string', 'max:500'],
            ...
            'next_occurrence' => ['nullable', 'date', 'after:due_date'],
            'tags' => ['nullable', 'array'],
            'tags.*' => ['string', 'max:100'],
