...
#[OA\Schema(
    schema: 'TextContentResource',
    title: 'Text Content Resource',
    description: 'Resource de contenido de texto',
    properties: [
        new OA\Property(property: 'id', type: 'integer', example: 1),
        new OA\Property(property: 'title', type: 'string', example: 'Sobre Nosotros'),
        new OA\Property(property: 'content', type: 'string', example: 'Contenido completo del texto...'),
